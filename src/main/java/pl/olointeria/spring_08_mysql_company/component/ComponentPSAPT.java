...
//    private Supplier supplier;
    ...
    public ComponentPSAPT(){};

    public ComponentPSAPT(Long id, String sapName, String sapNumber, String id_Sap, String customer, Long ppm, Long certificate, Long approval, String auditResult, String pscr, String location, String deliveryDeley, String interference, String collaboration, Long averageScore, String primaPlant, String supplier) {
        this.id = id;
