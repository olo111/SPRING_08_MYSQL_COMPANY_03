...
//        Iterable<Supplier> repositoryAll = supplierRepository.findAll();
...
//        List<Component> listProducts =componentRepository.findAll();
//
...
//        Component components = componentRepository.findById(id).get();
